  ...
  function init(options) {
    ...
    if (window.Dialogue) {
      const script = [
        ...
        { speaker: "Red", text: "I had my money on Andy Dufresne. A tall drink of water with a silver spoon up his ass.", portrait: "bigphilly" },
        { speaker: "Red", text: "I didn't think much of Andy the first time I laid eyes on him. Looked like a stiff breeze would blow him over.", portrait: "bigphilly" },
        { speaker: "Red", text: "The first night's the toughest, no doubt about it. When those bars slam home, that's when you know it's for real.", portrait: "bigphilly" },
        { speaker: "Red", text: "A whole life blown away in the blink of an eye. I remember my first night. Seems like a long time ago.", portrait: "bigphilly" },
      ];
